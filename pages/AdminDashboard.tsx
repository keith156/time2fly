            ...
            <div className="bg-white rounded-[40px] shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto border border-slate-200">
              ...
              <form onSubmit={saveDest} className="p-10 space-y-8">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    <label className="text-xs font-black text-slate-500 uppercase tracking-widest">Short Tagline (1-2 sentences)</label>
                    <textarea rows={2} value={editingDest.tagline || ''} onChange={e => setEditingDest({ ...editingDest, tagline: e.target.value })} className="w-full px-5 py-4 rounded-2xl bg-slate-50 border-none ring-1 ring-slate-200 focus:ring-2 focus:ring-amber-500 font-medium" placeholder="E.g. A journey through the heart of Africa..." />
                  </div>
                  <div className="space-y-2">
