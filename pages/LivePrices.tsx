                            ...
                            <table className="w-full text-left border-collapse min-w-full">
                                <thead>
                                    <tr className="bg-slate-50/50 border-b border-slate-100/80">
                                        <th className="py-4 px-4 sm:px-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 w-[30%] sm:w-[20%]">Departure</th>
                                        <th className="py-4 px-2 sm:px-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 w-[5%] block text-center"></th>
                                        <th className="py-4 px-4 sm:px-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 w-[30%] sm:w-[20%]">Destination</th>
                                        <th className="py-4 px-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 w-[20%] hidden sm:table-cell">Trend</th>
                                        <th className="py-4 px-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-right w-[20%] hidden md:table-cell">Est. Price (USD)</th>
                                        <th className="py-4 px-4 sm:px-6 text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 text-right w-[35%] sm:w-[15%]">Action</th>
                                    </tr>
                                </thead>
                                    ...
                                    {loading ? (
                                        ...
                                        liveTickets.map((ticket) => (
                                            <tr key={ticket.id} className="group hover:bg-blue-50/30 transition-colors">
                                                <td className="py-4 sm:py-5 px-4 sm:px-6 font-black text-slate-800 tracking-tight uppercase text-xs sm:text-base break-words">{ticket.from}</td>
                                                <td className="py-4 sm:py-5 px-0 text-center text-slate-300 group-hover:text-blue-400 transition-colors">
                                                    <Plane size={14} className="rotate-45 ml-1 sm:ml-2 sm:w-4 sm:h-4 w-3 h-3" />
                                                </td>
                                                <td className="py-4 sm:py-5 px-4 sm:px-6 font-black text-slate-800 tracking-tight uppercase text-xs sm:text-base break-words">{ticket.to}</td>
                                                <td className="py-4 sm:py-5 px-6 hidden sm:table-cell">
                                                ...
                                                <td className="py-4 sm:py-5 px-6 text-right font-black text-lg sm:text-xl tracking-tighter text-slate-900 hidden sm:table-cell">
                                                ...
                                                <td className="py-4 sm:py-5 px-4 sm:px-6 text-right">
                                                    <a
                                                        ...
                                                        className="inline-block whitespace-nowrap px-3 sm:px-4 py-2 bg-[#0000ff] hover:bg-slate-900 text-white rounded-lg font-black uppercase tracking-widest text-[9px] sm:text-[10px] transition-all shadow-md shadow-blue-500/20 active:scale-95"
                                                    >
                                                        Confirm
                                                    </a>
                                                </td>
