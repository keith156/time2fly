      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-[#002244]">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-20 w-full text-center">
          <div className="animate-fade-in-up space-y-10">
            <h1 className="text-[36px] font-black text-white leading-tight tracking-[0.2em] uppercase drop-shadow-2xl">
              IT'S <br />
              <span className="text-red-600">TIME 2 FLY</span>
            </h1>

            <p className="text-xl md:text-2xl text-slate-100 font-bold max-w-2xl mx-auto leading-relaxed uppercase tracking-widest text-justify">
              Explore the world, <span className="text-amber-500 border-b-4 border-red-600 pb-1">Travelling is knowledge</span>
            </p>

            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
              <Link to="/packages" className="group bg-amber-500 hover:bg-red-600 text-white px-12 py-6 rounded-2xl font-black transition-all shadow-2xl scale-100 hover:scale-105 active:scale-95 uppercase tracking-[0.2em] text-sm flex items-center">
                Plan Your Voyage <ArrowRight className="ml-3 group-hover:translate-x-2 transition-transform" />
              </Link>
              <Link to="/about" className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border-2 border-red-600 px-12 py-6 rounded-2xl font-black transition-all uppercase tracking-[0.2em] text-sm">
                Our Story
              </Link>
            </div>
          </div>
